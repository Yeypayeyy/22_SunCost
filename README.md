...
Sumber diagram: [`docs/class-diagram-suncost.drawio.xml`](docs/class-diagram-suncost.drawio.xml) (buka di app.diagrams.net).

### Struktur Kode

| Berkas | Isi |
|---|---|
| `Models/Lokasi.cs` | Koordinat serta luas, orientasi, dan kemiringan atap |
| `Models/PanelSurya.cs`, `TarifListrikPLN.cs`, `DataRadiasi.cs` | Spesifikasi panel, tarif PLN, dan data radiasi/suhu |
| `Models/SimulasiSkenario.cs` | Satu skenario beserta hasil simulasinya |
| `Services/LayananCuacaAPI.cs` | Pengambilan radiasi dan suhu dari Open-Meteo |
| `Services/KalkulatorEnergi.cs` | Kapasitas terpasang, koreksi suhu, produksi bulanan dan tahunan |
| `Services/AnalisisFinansial.cs` | Biaya instalasi, penghematan, payback, keuntungan 25 tahun |
| `Services/DampakLingkungan.cs` | Emisi CO2 yang dihindari dan setara pohon |
| `Services/RiwayatSimulasi.cs`, `RepositoriSimulasi.cs` | Riwayat skenario dan penyimpanan SQLite |
